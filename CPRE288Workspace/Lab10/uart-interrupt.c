...
void uart_interrupt_init(void){
  ...
  //calculate baud rate
  uint16_t iBRD = (uint16_t) (16000000.0 / (16 * 115200)); //use equations
  uint16_t fBRD = (uint16_t) (((16000000.0 / (16 * 115200)) - iBRD) * 64 + 0.5); //use equations
...
char uart_receive(void){
    ...
    //mask 4 error bits and grab only 8 data bits
